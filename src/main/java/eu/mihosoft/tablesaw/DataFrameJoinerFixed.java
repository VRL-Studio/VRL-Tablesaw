...
public class DataFrameJoinerFixed {
     ...
     */
    public DataFrameJoinerFixed(Table table, String... joinColumnNames) {
        this.table = table;
    ...
    public Table inner(boolean allowDuplicateColumnNames, Table... tables) {
        ...
        for (Table currT : tables) {
            joined =
                    joinInternal(joined, currT, DataFrameJoinerFixed.JoinType.INNER, allowDuplicateColumnNames, joinColumnNames);
        }
        return joined;
    }
    ...
    public Table inner(Table table2, boolean allowDuplicateColumnNames, String... col2Names) {
        Table joinedTable;
        joinedTable = joinInternal(table, table2, DataFrameJoinerFixed.JoinType.INNER, allowDuplicateColumnNames, col2Names);
        return joinedTable;
    }
    ...
    private Table joinInternal(
            Table table1,
            Table table2,
            DataFrameJoinerFixed.JoinType joinType,
        ...
        if (table1.rowCount() == 0 &&
                (joinType == DataFrameJoinerFixed.JoinType.LEFT_OUTER || joinType == DataFrameJoinerFixed.JoinType.INNER)) {
        ...
        for (Row row : table1) {
            ...
            if ((joinType == DataFrameJoinerFixed.JoinType.LEFT_OUTER || joinType == DataFrameJoinerFixed.JoinType.FULL_OUTER)
                    && table2Rows.isEmpty()) {
            ...
            if (joinType == DataFrameJoinerFixed.JoinType.FULL_OUTER || joinType == DataFrameJoinerFixed.JoinType.RIGHT_OUTER) {
    ...
    private Index indexFor(Table table, int colIndex) {
        ...
        if (type instanceof DateColumnType) {
            ...
            return new StringIndex(table.textColumn(colIndex).asStringColumn());
    ...
    public Table fullOuter(boolean allowDuplicateColumnNames, Table... tables) {
        ...
        for (Table currT : tables) {
            joined =
                    joinInternal(
                            joined, currT, DataFrameJoinerFixed.JoinType.FULL_OUTER, allowDuplicateColumnNames, joinColumnNames);
        }
        return joined;
    }
    ...
    public Table fullOuter(Table table2, String col2Name) {
        return joinInternal(table, table2, DataFrameJoinerFixed.JoinType.FULL_OUTER, false, col2Name);
    }
    ...
    public Table leftOuter(Table table2, boolean allowDuplicateColumnNames, String... col2Names) {
        return joinInternal(table, table2, DataFrameJoinerFixed.JoinType.LEFT_OUTER, allowDuplicateColumnNames, col2Names);
    }
    ...
    public Table rightOuter(Table table2, boolean allowDuplicateColumnNames, String... col2Names) {
        return joinInternal(table, table2, DataFrameJoinerFixed.JoinType.RIGHT_OUTER, allowDuplicateColumnNames, col2Names);
    }
    ...
    private Set<Integer> emptyTableFromColumns(
        ...
        for (int c = 0; c < cols.length; c++) {
            if (joinType == DataFrameJoinerFixed.JoinType.RIGHT_OUTER) {
    ...
    private void withMissingRight(
        ...
        if (joinType == DataFrameJoinerFixed.JoinType.FULL_OUTER) {
